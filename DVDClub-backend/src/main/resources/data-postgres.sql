...
insert into public.user (user_id, user_name, user_surname, user_email, user_password, user_phone, user_gender, user_type, enabled) values (default, 'Dragan', 'Torbica', 'dragan@gmail.com', 'asd','12345', 0, 1, true);
insert into public.user (user_id, user_name, user_surname, user_email, user_password, user_phone, user_gender, user_type, enabled) values (default, 'Djordje', 'Cvarkov', 'djordje@gmail.com', 'asd','12345', 0, 1, true);
...
insert into public.marketplace_dvd (marketplace_id, dvd_id) values (1,1), (1,2), (1,3), (1,4), (1,5), (1,6);

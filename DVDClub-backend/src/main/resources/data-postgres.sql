...
insert into public.marketplace (marketplace_id, marketplace_name, marketplace_street, marketplace_number, city_city_id) values (default, 'Markeyplace 021', 'Bulevar Oslobodjenja', '44', 1);
